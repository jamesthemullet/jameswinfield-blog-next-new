...
- [x] Add a `<link rel="canonical">` tag in `components/meta.tsx` — the `seoProps` type already declares `seo.canonical` but it's never rendered; pages currently rely on `og:url` alone (found: 2026-09-01) (resolved: 2026-09-15, PR #TBD)
