...
- [x] Add an `<h1>` to `pages/blog.tsx` — the page currently jumps straight to an `<h3>` (`hero-post.tsx`) then `<h2>` ("More Stories"), with zero h1s, unlike every other route (found: 2026-09-01) (resolved: 2026-09-17, PR #TBD)
